...
class combine_lanes {
    ...
    public:
        ...
        void load_maps();
        std::vector<std::string> combine_vectors(std::vector<std::string> vec1, 
            std::vector<std::string> vec2, std::string delim);
        std::map<std::string, std::string> make_map(std::vector<std::string> vec1, 
            std::vector<std::string> vec2);
        std::vector<std::string> change_to_string(std::vector<int> vec);
...
std::vector<std::string> combine_lanes::change_to_string(std::vector<int> vec) {
...
std::vector<std::string> combine_lanes::combine_vectors
    ...
    for (size_t j = 0; j < vec1.size(); j++) {
        std::string var1 = vec1[j];
        std::string var2 = vec2[j];
...
void combine_lanes::load_maps() {
    ...
    std::vector<std::string> i7_quadrant_sv = change_to_string(i7_quadrant);
    std::vector<std::string> i7_column_sv = change_to_string(i7_column); 
    std::vector<std::string> i7_key_quadrant = combine_vectors(i7_key, i7_quadrant_sv, "_");
    std::vector<std::string> i7_row_column = combine_vectors(i7_row, i7_column_sv, "");
    ...
    std::vector<std::string> primer_plate_sv = change_to_string(primer_plate);
    std::vector<std::string> pool_sv = change_to_string(pool);
    std::vector<std::string> primer_plate_pool = combine_vectors(primer_plate_sv, pool_sv, "_");
